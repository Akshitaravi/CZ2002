...
public class StudentControl extends CourseControl {
	...
	public static void addCourse(Student student, String courseID, int indexID) {
		...
		if (vacancy <= 0) {
			...
			System.out.println("There are not vacancies in this index," + indexID + "," + courseID
	...
	public static void swapIndex(Student swapStudent, Student peer, String courseID, int swapStuIndexNumber,
			int peerIndexNumber) {
